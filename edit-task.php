	...
	<body>
		...
		<div class="body">
			...
			<section class="section-1">
				<h4 class="title">Cập nhật nhiệm vụ <a href="tasks.php">Nhiệm vụ</a></h4>
				<form class="form-1"
					method="POST"
					...
					<div class="input-holder">
						<lable>Nhắc lại</lable>
						<input type="date" name="due_date" class="input-1" placeholder="Nhắc lại" value="<?= $task['due_date'] ?>"><br>
					</div>
