	...
	<body>
		...
		<div class="body">
			...
			<section class="section-1">
				<h4 class="title-2">
					<a href="create_task.php" class="btn">Tạo nhiệm vụ</a>
					<a href="tasks.php?due_date=Due Today">Ngày đến hạn</a>
					<a href="tasks.php?due_date=Overdue">Quá hạn</a>
					<a href="tasks.php?due_date=No Deadline">Không có thời hạn</a>
					<a href="tasks.php">Tất cả nhiệm vụ</a>
					...
					<table class="main-table">
						...
						foreach ($tasks as $task) { ?>
							<tr>
								...
								<td><?= $task['status'] ?></td>
								<td>
									<a href="edit-task.php?id=<?= $task['id'] ?>" class="edit-btn">Cập nhật</a>
